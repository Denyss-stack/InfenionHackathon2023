// ======================================================================
// Design07.v generated from TopDesign.cysch
// 11/02/2023 at 13:26
...
module top ;
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_11 or Net_12 or Net_17)
        begin
            case (Net_17)
                1'b0 :  tmp__mux_1_reg = Net_11;
                1'b1 :  tmp__mux_1_reg = Net_12;
            endcase
        end
        assign Net_15 = tmp__mux_1_reg;
    end
    // -- Mux end --


	cy_clock_v1_0
		#(.id("5fd7c287-cbf9-4fe4-8545-93516a920895"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("681f73bd-b686-45fa-85a9-b9ff2a19576c"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
    ...
    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_27)
    begin
        cy_tff_1 <= Net_26^Net_11;
    end
    assign Net_11 = cy_tff_1;
    // -- TFF End --
    ...
    begin
        cy_tff_2 <= Net_29^Net_12;
    end
    assign Net_12 = cy_tff_2;
    // -- TFF End --
