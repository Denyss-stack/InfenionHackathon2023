// ======================================================================
// teamProject.v generated from TopDesign.cysch
// 11/03/2023 at 15:50
...
module ADC_SAR_SEQ_P4_v2_50_1 (
	...
	cy_clock_v1_0
		#(.id("5e9afc45-65bc-488e-a021-dd3fff1fbdb3/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("976562500"),
		  .is_direct(0),
...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("87ccbf91-eb7e-4c25-a9a0-77bfc1eddc6e/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("a08c7c8b-ca1f-4789-9e19-5ce69653d0dc"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("19ed1422-f5a0-491d-b4ae-a6a05e6c7d6e"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("45fbdaec-766c-4411-9f60-b37c71f269a7"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    assign Net_124 = ~Net_69;


    assign Net_123 = ~Net_70;


    assign Net_122 = ~Net_71;


    assign Net_121 = ~Net_72;
	...
	cy_psoc3_pins_v1_10
		#(.id("51676263-3cea-4095-9701-3dc7a9fe32d1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d858658e-6826-44f5-b79a-c283b32296f9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b7bbcc4f-7ac4-4356-a78f-6863dc826cdb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("269405b4-b245-4870-a9c0-3582eb09bc45"),
	...
	wire [0:0] tmpOE__PinOut_Buzz_net;
	wire [0:0] tmpFB_0__PinOut_Buzz_net;
	wire [0:0] tmpIO_0__PinOut_Buzz_net;
	wire [0:0] tmpINTERRUPT_0__PinOut_Buzz_net;
	electrical [0:0] tmpSIOVREF__PinOut_Buzz_net;

	cy_psoc3_pins_v1_10
		#(.id("6df570e1-c9f6-4924-a213-6965f84c0402"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PinOut_Buzz
		 (.oe(tmpOE__PinOut_Buzz_net),
		  .y({Net_90}),
		  .fb({tmpFB_0__PinOut_Buzz_net[0:0]}),
		  .io({tmpIO_0__PinOut_Buzz_net[0:0]}),
		  .siovref(tmpSIOVREF__PinOut_Buzz_net),
		  .interrupt({tmpINTERRUPT_0__PinOut_Buzz_net[0:0]}),
		  .annotation({Net_89}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PinOut_Buzz_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_3 Buzz_PWM (
        .capture(1'b0),
        .cc(Net_92),
        .clock(Net_93),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("7ae247f3-f8af-4f00-b84e-3792da523077"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__butt_cheat_net;
	wire [0:0] tmpFB_0__butt_cheat_net;
	wire [0:0] tmpIO_0__butt_cheat_net;
	wire [0:0] tmpINTERRUPT_0__butt_cheat_net;
	electrical [0:0] tmpSIOVREF__butt_cheat_net;

	cy_psoc3_pins_v1_10
		#(.id("d613e93d-ac63-4872-9c97-021a4a3edef1"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		butt_cheat
		 (.oe(tmpOE__butt_cheat_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__butt_cheat_net[0:0]}),
		  .io({tmpIO_0__butt_cheat_net[0:0]}),
		  .siovref(tmpSIOVREF__butt_cheat_net),
		  .interrupt({tmpINTERRUPT_0__butt_cheat_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__butt_cheat_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
